...
Traditional analyses of accelerometer data focus on the total activity over the day. Using your tidied dataset, aggregate accross minutes to create a total activity variable for each day, and create a table showing these totals. 
...
Based on this graph, it's apparent that the most significant spikes in activity occur on Friday and Sunday. On each day, around minute=250, the patient's activity begins to climb, but then remains relatively stable from minute=500 to minute=1000. 